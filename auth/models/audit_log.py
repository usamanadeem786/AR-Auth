...
from auth.models.generics import GUID, TIMESTAMPAware, UUIDModel
...
class AuditLogMessage(StrEnum):
    ...
    ORGANIZATION_MEMBER_PERMISSION_ADDED = "ORGANIZATION_MEMBER_PERMISSION_ADDED"
    ORGANIZATION_MEMBER_PERMISSION_REMOVED = "ORGANIZATION_MEMBER_PERMISSION_REMOVED"
    ORGANIZATION_MEMBER_REMOVED = "ORGANIZATION_MEMBER_REMOVED"
    ORGANIZATION_INVITATION_REQUESTED = "ORGANIZATION_INVITATION_REQUESTED"
