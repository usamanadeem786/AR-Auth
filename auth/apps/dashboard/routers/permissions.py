...
from auth.apps.dashboard.forms.permission import PermissionCreateForm
...
from auth.models import AuditLogMessage, Permission
from auth.repositories import PermissionRepository
...
async def list_permissions(
    ...
    if await form_helper.is_submitted_and_valid():
        ...
        return HXRedirectResponse(
            ...
            headers={"X-Auth-Object-Id": str(permission.id)},
        )
