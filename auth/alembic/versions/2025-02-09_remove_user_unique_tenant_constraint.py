...
def upgrade():
    ...
    op.drop_constraint("auth_users_email_tenant_id_key", "auth_users", type_="unique")
    op.create_unique_constraint(op.f("auth_users_email_key"), "auth_users", ["email"])
...
def downgrade():
    ...
    op.create_unique_constraint(
        "auth_users_email_tenant_id_key", "auth_users", ["email", "tenant_id"]
    )
    # ### end Alembic commands ###
