...
from auth.apps import api_app, auth_app, dashboard_app
...
from auth.lifespan import lifespan
from auth.middlewares.x_forwarded_host import XForwardedHostMiddleware
from auth.settings import settings
from auth.tasks.base import redis_broker
