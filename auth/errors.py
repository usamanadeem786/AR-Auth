...
class APIErrorCode(StrEnum):
    ...
    TENANT_CREATE_NOT_EXISTING_ROLE = "TENANT_CREATE_NOT_EXISTING_ROLE"

    TENANT_UPDATE_NOT_EXISTING_THEME = "TENANT_UPDATE_NOT_EXISTING_THEME"
    TENANT_UPDATE_NOT_EXISTING_OAUTH_PROVIDER = (
        "TENANT_UPDATE_NOT_EXISTING_OAUTH_PROVIDER"
    )
    TENANT_UPDATE_NOT_EXISTING_ROLE = "TENANT_UPDATE_NOT_EXISTING_ROLE"
    ...
    ORGANIZATION_CREATE_ALREADY_EXISTS = "ORGANIZATION_CREATE_ALREADY_EXISTS"
    ...
    ORGANIZATION_MEMBER_PERMISSION_NOT_FOUND = "ORGANIZATION_MEMBER_PERMISSION_NOT_FOUND"
    ORGANIZATION_MEMBER_PERMISSION_ALREADY_EXISTS = "ORGANIZATION_MEMBER_PERMISSION_ALREADY_EXISTS"
    ...
    ORGANIZATION_INVITATION_ALREADY_ACCEPTED = "ORGANIZATION_INVITATION_ALREADY_ACCEPTED"
    ORGANIZATION_INVITATION_EMAIL_MISMATCH = "ORGANIZATION_INVITATION_EMAIL_MISMATCH"
    ORGANIZATION_INVITATION_ALREADY_EXISTS = "ORGANIZATION_INVITATION_ALREADY_EXISTS"
    ORGANIZATION_INVITATION_MAX_LIMIT_REACHED = "ORGANIZATION_INVITATION_MAX_LIMIT_REACHED"
