...
class APIErrorCode(StrEnum):
    ...
    CLIENT_INVALID_REDIRECT_URI = "CLIENT_INVALID_REDIRECT_URI"
    ...
    ORGANIZATION_MEMBER_PERMISSION_NOT_FOUND = (
        "ORGANIZATION_MEMBER_PERMISSION_NOT_FOUND"
    )
    ORGANIZATION_MEMBER_PERMISSION_ALREADY_EXISTS = (
        "ORGANIZATION_MEMBER_PERMISSION_ALREADY_EXISTS"
    )
    ...
    ORGANIZATION_INVITATION_MAX_LIMIT_REACHED = (
        "ORGANIZATION_INVITATION_MAX_LIMIT_REACHED"
    )
